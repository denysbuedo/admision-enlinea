...
import { usePrograms } from '@/hooks/usePrograms'; // Asumiendo que ya tienes este hook
import { Search, Filter, GraduationCap, Clock, Building2 } from 'lucide-react';
...
export default function ProgramsPage() {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-8">Buscar Programas Académicos</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredPrograms.length > 0 ? (
          filteredPrograms.map((program: any) => (
            <div key={program.id} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-6 border border-gray-100">
